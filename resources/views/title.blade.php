    ...
    <div class="container">
      <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
        <a href="/" class="d-flex align-items-center mb-2 mb-lg-0 text-white text-decoration-none">
          <img src="/img/cubeicon.png" class="bi me-2" width="40" height="40" role="img" aria-label="Cube">
        </a>
        ...
        <button onclick="window.location.href='/logout'" type="button" class="btn btn-outline-light me-2">Log Out</button>
        </div>
      </div>
    </div>
  </header>